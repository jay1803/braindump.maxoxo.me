...
[value delivery](#org77916a8), or [profit](#orgcec0b72) [sufficiency](#org09c8e21)—and you have something other than a
...
delivery](#org77916a8) and operations). Customer satisfaction depends on reliably exceeding
the customer’s expectations (customer [service](#orgea231d4)). [Profit](#orgcec0b72) [sufficiency](#org09c8e21) requires
...
5.  So that the business brings in enough [profit](#orgcec0b72) to make it worthwhile for the
...
Rate each of the ten factors below on a [scale](#orgb765b0f) of 0 to 10, where 0 is
...
4.  Cost of Customer Acquisition—How easy is it to acquire a new customer? On
    ...
    effort?
5.  Cost of [Value Delivery](#org77916a8)—How much would it cost to create and deliver the
...
1.  [[Product](#org45e16a1)]: Create a single tangible item or entity, then sell and deliver
    it for more than what it cost to make.
2.  [[Service](#orgea231d4)]: Provide help or assistance, then charge a fee for the benefits
    rendered.
3.  [Shared Resource]: Shared Resource. Create a durable asset that can be
    used by many people, then charge for access.
4.  [[Subscription](#org6ccd8be)]: [Subscription](#org6ccd8be). Offer a benefit on an ongoing basis, and
    charge a recurring fee.
5.  [[Resale](#org42192eb)]: Acquire an asset from a wholesaler, then sell that asset to a
    retail buyer at a higher price.
6.  [[Lease](#org59ad6c6)]: Acquire an asset, then allow another person to use that asset for
    a predefined amount of time in exchange for a fee.
7.  [[Agency](#org80a617c)]: Get the attention of a group of people with certain
...
11. [Capital]: Purchase an ownership stake in a business, then collect a
    corresponding portion of the [profit](#orgcec0b72) as a one-time payout or ongoing
    dividend.


### 1.11 Form of Value #1: [Product](#org45e16a1) {#1-dot-11-form-of-value-1-product}

<a id="org45e16a1">Product</a> [产品](20210412125507-product.md)
To run a [Product](#org45e16a1)-oriented business, you must:
...
3.  Sell as many units as possible for as high a price as the market will
    bear.
4.  Keep enough inventory of finished [product](#org45e16a1) available to fulfill orders as
    they come in.


### 1.12 Form of Value #2: [Service](#orgea231d4) {#1-dot-12-form-of-value-2-service}

<a id="orgea231d4">Service</a> [服务](20210412125643-service.md)
In order to create a successful [Service](#orgea231d4), your business must:

1.  Have employees capable of a skill or ability other people require but
    can’t, won’t, or don’t want to use themselves.
2.  Ensure that the [Service](#orgea231d4) is provided with consistently high quality.
...
### 1.14 Form of Value #4: [Subscription](#org6ccd8be) {#1-dot-14-form-of-value-4-subscription}

<a id="org6ccd8be">Subscription</a> [订阅](20210412125806-subscription.md)
In order to create a successful [Subscription](#org6ccd8be), you must:
...
### 1.15 Form of Value #5: [Resale](#org42192eb) {#1-dot-15-form-of-value-5-resale}

<a id="org42192eb">Resale</a> [转卖](20210412130023-resale.md)
In order to provide value as a reseller, you must:

1.  Purchase a [product](#org45e16a1) as inexpensively as possible, usually in bulk.
2.  Keep the [product](#org45e16a1) in good condition until sale—damaged goods can’t be
    sold.
3.  Find potential purchasers of the [product](#org45e16a1) as quickly as possible to keep
    inventory costs low.
4.  Sell the [product](#org45e16a1) for as high a markup as possible, preferably a multiple
    of the purchase price.


### 1.16 Form of Value #6: [Lease](#org59ad6c6) {#1-dot-16-form-of-value-6-lease}

<a id="org59ad6c6">Lease</a> [出租](20210412130107-lease.md)
In order to provide value via a [Lease](#org59ad6c6), you must:

1.  Acquire an asset people want to use.
2.  [Lease](#org59ad6c6) the asset to a paying customer on favorable terms.
3.  Protect yourself from unexpected or adverse events, including the loss or
    damage of the leased asset.


### 1.17 Form of Value #7: [Agency](#org80a617c) {#1-dot-17-form-of-value-7-agency}

<a id="org80a617c">Agency</a> [代理](20210412130149-agency.md)
In order to provide value via [Agency](#org80a617c), you must:
...
2.  Do you own or [lease](#org59ad6c6) it? If you own it, are you still making payments?
...
[Price Elasticity of Demand](price-elasticity-of-demand.md)
...
reinforcing the Reason Why a  [Transaction](transaction.md) will be valuable to the customer, you
simultaneously increase the likelihood of a [Transaction](transaction.md) as well as the
...
Exclusivity is easiest to maintain when you’ve created something new, which means an exclusivity strategy makes the most sense for [Product](#org45e16a1) and [Service](#orgea231d4).
...
Setup is the negotiation equivalent of [Guiding Structure](#org0fefae9).
...
If a prospect feels that you’re desperate to make a sale, it diminishes their interest in a matter of seconds. Desperation is a subtle signal that other people don’t find your offer desirable, and [Social Proof](20210728095330-social_proof.md) starts working against you.
...
Objections #4 and #5 (“I can wait” / “it’s too difficult”) are best addressed via Education-Based Selling. Often, your prospects haven’t fully realized they have a problem, particularly in the case of [Absence Blindness](#org6bc1712).
...
Since Netflix is a [Subscription](#org6ccd8be) business, every reactivated customer means a new monthly stream of income, which greatly enhances the Lifetime Valueof each customer.
Your cost of customer acquisition (a component of [Allowable Acquisition Cost](#orgaed4ba6)) is extremely low.
Make it a priority every three to six months to contact your lapsed customers with another offer.


## 4. [Value Delivery](#org77916a8) {#4-dot-value-delivery}
...
<a id="org77916a8">Value Delivery</a> [价值传递](20210801225945-value_delivery.md)
...
### 4.1 [Value Stream](#orgb213d66) {#4-dot-1-value-stream}

Great design is eliminating all unnecessary details.
—MINH D. TRAN, TECHNOLOGIST AND DESIGNER

<a id="orgb213d66">Value Stream</a> [价值流](20210801230039-value_stream.md)
 A [Value Stream](#orgb213d66) is the set of all steps and all processes from the start of
 your Value Creation process all the way through the delivery of the end result
 to your customer.

You can think of the [Value Stream](#orgb213d66) as a combination of your Value Creation and
[Value Delivery](#org77916a8) processes.

The Toyota Production System (TPS) was the first large-[scale](#orgb765b0f) manufacturing
operation to systematically examine its entire [Value Stream](#orgb213d66) on a regular
...
The best way to understand your [Value Stream](#orgb213d66) is to diagram it.
In general, try to make your [Value Stream](#orgb213d66) as small and efficient as possible.


### 4.2 [Distribution Channel](#orgf6703d9) {#4-dot-2-distribution-channel}

<a id="orgf6703d9">Distribution Channel</a> [分销渠道](20210801230335-distribution_channel.md)
A [Distribution Channel](#orgf6703d9) describes how your form of value is actually
...
certain amount of control over your [Value Delivery](#org77916a8) process.


### 4.3 The [Expectation Effect](#org8d0333b) {#4-dot-3-the-expectation-effect}

<a id="org8d0333b">Expectation Effect</a> [期望效应](20210801231021-expectancy_effect.md)
\`[Expectation Effect](#org8d0333b): Quality = Performance - Expectations.\`
...
### 4.4 [Predictability](#org0371caf) {#4-dot-4-predictability}

<a id="org0371caf">Predictability</a> 可预测的
...
Improving [Predictability](#org0371caf) has major Reputation and value perception benefits


#### HOW {#how}

There are three primary factors that influence the [Predictability](#org0371caf) of an offer:
...
### 4.5 [Throughput](#org7a3f38a) {#4-dot-5-throughput}

<a id="org7a3f38a">Throughput</a> [生产力](20210801231336-throughput.md)
[Throughput](#org7a3f38a) is the rate at which a system achieves its desired goal. It’s the
measure of effectiveness of your [Value Stream](#orgb213d66). It’s measured in the form of
units/time: the higher the number of units and the lower the time, the higher
the [throughput](#org7a3f38a).

-   Dollar [Throughput](#org7a3f38a)- is a measure of how quickly your overall business system creates a dollar of [profit](#orgcec0b72).
-   Unit [Throughput](#org7a3f38a)- is a measure of how much time it takes to create an additional unit for sale.
-   Satisfaction [Throughput](#org7a3f38a)- is a measure of how much time it takes to create a happy, satisfied customer.


#### HOW {#how}

The best way to begin increasing [Throughput](#org7a3f38a) is to start measuring it.


### 4.6 [Duplication](#orgbc4213a) {#4-dot-6-duplication}

<a id="orgbc4213a">Duplication</a> 复制
[Duplication](#orgbc4213a) is the ability to reliably reproduce something of value.

As Kevin Kelly remarked in his essay “Better Than Free,” the Internet is
essentially an enormous, inexpensive copy machine.


### 4.7 [Multiplication](#org4fbfa45) {#4-dot-7-multiplication}

<a id="org4fbfa45">Multiplication</a> 增长


#### WHY {#why}

[Multiplication](#org4fbfa45) is [Duplication](#orgbc4213a) for an entire process or System. McDonald’s
began as a single restaurant in California


#### HOW {#how}

[Multiplication](#org4fbfa45) is what separates small businesses from huge businesses.
...
[Multiplication](#org4fbfa45) can expand a business’s ability to deliver value to more
customers.


### 4.8 [Scale](#orgb765b0f) {#4-dot-8-scale}

<a id="orgb765b0f">Scale</a> 规模

> Humans don’t [Scale](#orgb765b0f)......in Performance Load, a person’s effectiveness usually
> goes down as the demands on them increase.


#### WHAY {#whay}

[Scale](#orgb765b0f) is the ability to reliably Duplicate or Multiply a process as volume increases.
...
### 4.9 [Accumulation](#org8ec0c38) {#4-dot-9-accumulation}

<a id="org8ec0c38">Accumulation</a> 积累，量变到质变
...
Incremental Augmentation is an example of the power of [Accumulation](#org8ec0c38). If your
...
Small changes to your [Value Delivery](#org77916a8) process can save you a ton of time and
effort in the long run.


### 4.10 [Amplification](#orgf3b414d) {#4-dot-10-amplification}

<a id="orgf3b414d">Amplification</a> 放大
making a small change to a scalable System produces a huge result.


#### HOW {#how}

The best way to identify [Amplification](#orgf3b414d) opportunities is to look for things
...
Every improvement you make to your [Value Stream](#orgb213d66) make it harder for potential competitors to keep up.
...
### 4.13 [Systemization](#org354e95e) {#4-dot-13-systemization}

<a id="org354e95e">Systemization</a> 组织化，分类
...
### 5.1 [Profit](#orgcec0b72) {#5-dot-1-profit}

<a id="orgcec0b72">Profit</a> [利润](profit.md)
[Profit](#orgcec0b72) is a very simple concept: it’s bringing in more money than you spend.


#### WHY {#why}

[Profit](#orgcec0b72) is important because it allows businesses to stay in operation.
[Profit](#orgcec0b72) also provides a “cushion” that allows the business to weather unexpected events.
but it’s not the be-all and end-all of business.
For some people (like me), business is more of a creative endeavor—a way to explore what’s possible, help others, and support yourself at the same time. From this perspective, as long as you’re making enough [Profit](#orgcec0b72), your business will continue to be successful.


### 5.2 [Profit Margin](#org45d74c2) {#5-dot-2-profit-margin}

<a id="org45d74c2">Profit Margin</a> [利润率](20210216092545-rate_of_profit.md)
[Profit Margin](#org45d74c2) (often abbreviated to “margin”) is the difference between how much revenue you capture and how much you spend to capture it, expressed in percentage terms.

Formula for [profit margin](#org45d74c2):
((Revenue – Cost) / Revenue) × 100= % [Profit Margin](#org45d74c2)


#### USAGE {#usage}

Most businesses try to keep each offer’s [Profit Margin](#org45d74c2) as high as possible, which makes sense: the higher the margin, the more money the business gets to keep from each sale.
Businesses often use [Profit Margin](#org45d74c2) as a way of comparing offers.
...
### 5.3 [Value Capture](#org5d4ed96) {#5-dot-3-value-capture}

<a id="org5d4ed96">Value Capture</a> [价值获取](20210801231923-value_capture.md)
 [Value Capture](#org5d4ed96) is the process of retaining some percentage of the value provided in every Transaction.

There are two dominant philosophies behind [Value Capture](#org5d4ed96): maximization and minimization.
...
### 5.4 [Sufficiency](#org09c8e21) {#5-dot-4-sufficiency}

<a id="org09c8e21">Sufficiency</a> 充足


#### WHY {#why}

business is not necessarily about maximizing Profits.
you have enough [profit](#orgcec0b72) to do the things you need to do to keep the business running and make it worth your time, you’re successful


#### WHAT {#what}

[Sufficiency](#org09c8e21) is the point where a business is bringing in enough [profit](#orgcec0b72) that the people who are running the business find it worthwhile to keep going for the foreseeable future.
You can track financial [sufficiency](#org09c8e21) using a number called “target monthly revenue” (TMR).


### 5.5 [Valuation](#org2916efd) {#5-dot-5-valuation}

<a id="org2916efd">Valuation</a> [估值](20210802204348-valuation.md)
[Valuation](#org2916efd) is an estimate of the total worth of a company.


### 5.6 [Cash Flow Statement](#org80a94d8) {#5-dot-6-cash-flow-statement}

<a id="org80a94d8">Cash Flow Statement</a> [现金流量表](cash-flow-statement.md)

I recommend starting with the [Cash Flow Statement](#org80a94d8).

The [Cash Flow Statement](#org80a94d8) is straightforward: it’s an examination of a company’s bank account over a certain period of time


### 5.7 [Income Statement](#orgcd3f69b) {#5-dot-7-income-statement}

<a id="orgcd3f69b">Income Statement</a> [损益表](income-statement.md)


#### WHAT {#what}

the [Income Statement](#orgcd3f69b) contains an estimate of the business’s [Profit](#orgcec0b72) over a certain period of time, once revenue is matched with the related expenses.
Net [Profit](#orgcec0b72)
\`Revenue – Cost of Goods Sold – Expenses – Taxes = Net [Profit](#orgcec0b72)\`


### 5.8 [Balance Sheet](#orge848ca8) {#5-dot-8-balance-sheet}

<a id="orge848ca8">Balance Sheet</a> [资产负债表](balance-sheet.md)
[Balance Sheet](#orge848ca8) is a snapshot of what a business owns and what it owes at a particular moment in time.
...
### 5.9 [Financial Ratios](#orgcd5a0b9) {#5-dot-9-financial-ratios}

<a id="orgcd5a0b9">Financial Ratios</a> [财务比率](20210801232458-financial_ratios.md)


#### WHY {#why}

[Financial Ratios](#orgcd5a0b9) are beneficial because they allow you to make comparisons very quickly.
Profitability ratios indicate a business’s ability to generate [Profit](#orgcec0b72)]].


#### WHAT {#what}

Return on Assets which is calculated by dividing net [profit](#orgcec0b72) by total assets, tells you what percentage of every dollar invested in the business was returned as [profit](#orgcec0b72).

[Leverage](#org1d61806) ratios indicate how your company uses debt.
...
### 5.10 [Cost-Benefit Analysis](#org490f1b2) {#5-dot-10-cost-benefit-analysis}

<a id="org490f1b2">Cost-Benefit Analysis</a> 成本效益分析
[Cost-Benefit Analysis](#org490f1b2) is the process of examining potential changes to your business to see if the benefits outweigh the costs.
...
### 5.12 [Pricing Power](#orgbeb47b4) {#5-dot-12-pricing-power}

<a id="orgbeb47b4">Pricing Power</a> [定价权](20210801232824-pricing_power.md)


#### WHAT {#what}

[Pricing Power](#orgbeb47b4) is your ability to raise the prices you’re charging over time.


#### WHY {#why}

[Pricing Power](#orgbeb47b4) is related to a concept economists call “price elasticity.”Price Elasticity of Demand If customers are very sensitive to the price of your offer, you’ll lose many customers with even a slight increase in price...
[Pricing Power](#orgbeb47b4) is important because raising your prices allows you to overcome the adverse effects of inflation and increased costs.


### 5.13 [Lifetime Value](#org2e1af77) {#5-dot-13-lifetime-value}

<a id="org2e1af77">Lifetime Value</a> [LTV](customer-lifetime-value.md)
 [Lifetime Value](#org2e1af77) is the total value of a customer’s business over the lifetime of their relationship with your company.


#### WHY {#why}

One of the reasons Subscriptions are so profitable is that they naturally maximize [Lifetime Value](#org2e1af77).


#### HOW {#how}

it’s much better to operate in markets where customers have a high [Lifetime Value](#org2e1af77).


### 5.14 [Allowable Acquisition Cost](#orgaed4ba6) {#5-dot-14-allowable-acquisition-cost}

<a id="orgaed4ba6">Allowable Acquisition Cost</a> 获客成本


#### WHAT {#what}

[Allowable Acquisition Cost](#orgaed4ba6) (AAC) is the marketing component of [Lifetime Value](#org2e1af77).


#### WHY {#why}

The higher the average customer’s [Lifetime Value](#org2e1af77), the more you can spend to attract a new customer, making it possible to spread the word about your offer in new ways.


#### HOW {#how}

How...not losing money hand over fist?......The answer is [Subscription](#org6ccd8be).

<!--list-separator-->

-  HOW TO CALCULATE

    To calculate AAC, start with...average [Lifetime Value](#org2e1af77), then subtract（减去） your [Value Stream](#orgb213d66) costs—what it takes to create and deliver the value promised to that customer over your entire relationship with them. Then subtract your [Overhead](#orgb31446e) divided by your total customer base, which represents the [Fixed Costs](#org75c7c04) you’ll need to pay to stay in business over that period of time. Multiply the result by 1 minus your desired [Profit Margin](#org45d74c2)  (if you’re shooting for a 60 percent margin, you’d use 1.00 − 0.60=0.40), and that’s your AAC.

    The higher the [Lifetime Value](#org2e1af77) of your customers, the higher the [Allowable Acquisition Cost](#orgaed4ba6).


### 5.15 [Overhead](#orgb31446e) {#5-dot-15-overhead}

<a id="orgb31446e">Overhead</a> [日常开支](20210801233213-overhead.md)
[Overhead](#orgb31446e) represents the minimum ongoing resources required for a business to continue operation.


#### WHY {#why}

The lower your [Overhead](#orgb31446e), the less revenue the business requires to continue operation, and the more quickly you’ll reach your point of financial [Sufficiency](#org09c8e21).

[Overhead](#orgb31446e) is critically important if you are building your company on a fixed amount of Capital.


### 5.16 Costs: Fixed and Variable {#5-dot-16-costs-fixed-and-variable}

<a id="org75c7c04">Fixed Costs</a>  [固定成本](20210801233400-fixed_costs.md)
[Fixed Costs](#org75c7c04) are incurred no matter how much value you create.

<a id="orge1ed95f">Variable Costs</a> [可变成本](variable-costs.md)
[Variable Costs](#orge1ed95f) are directly related to how much value you create.


#### HOW {#how}

Reductions in [Fixed Costs](#org75c7c04) [Accumulate; reductions in [Variable Costs](#orge1ed95f) are Amplified by volume.
...
Cutting costs can help you increase your [Profit Margin](#org45d74c2), but it often comes at a steep price.


#### HOW {#how}

Cutting costs that are wasteful or unnecessary is certainly a good idea, but [Diminishing Returns](#org6bc1fd8) always kick in—be careful not to throw the baby out with the bath water.


### 5.18 [Breakeven](#org0c7cc28) {#5-dot-18-breakeven}

<a id="org0c7cc28">Breakeven</a> [收支平衡点](20210727170542-breakeven.md)
[Breakeven](#org0c7cc28) is the point where your business’s total revenue to date is equal
to its total expenses to date—it’s the point where your business starts
creating wealth instead of consuming it.


### 5.19 [Amortization](#org31bc4ab) {#5-dot-19-amortization}

<a id="org31bc4ab">Amortization</a> [分期偿还](20210222220046-amortization.md)


#### WHAT {#what}

[Amortization](#org31bc4ab) is the process of spreading the cost of a resource investment
over the estimated useful life of that investment.


#### WHY {#why}

[Amortization](#org31bc4ab) can help you determine whether or not a big expense is a good
idea.


#### HOW TO CALCULATE {#how-to-calculate}

[Amortization](#org31bc4ab) depends on an accurate assessment of useful life, which is a
prediction. [Amortization](#org31bc4ab) doesn’t work well if you don’t sell what you
produce or if your equipment wears out more quickly than expected


### 5.20 [Purchasing Power](#orgec89410) {#5-dot-20-purchasing-power}

<a id="orgec89410">Purchasing Power</a> 购买力


#### WHAT {#what}

[Purchasing Power](#orgec89410) is the sum total of all liquid assets a business has at its
disposal（处理）.

[Purchasing Power](#orgec89410) is what you use to pay your [Overhead](#orgb31446e) and your suppliers


#### HOW {#how}

Always keep track of how much [Purchasing Power](#orgec89410) you have available.
...
The more [Purchasing Power](#orgec89410) you have, the more Resilient your business is and
the better your ability to handle the unexpected.


### 5.22 [Opportunity Cost](#orgc732f6b) {#5-dot-22-opportunity-cost}

<a id="orgc732f6b">Opportunity Cost</a> [机会成本](20210801233743-opportunity_cost.md)


#### WHAT {#what}

[Opportunity Cost](#orgc732f6b) is the value you’re giving up by making a Decision.
...
[Diminishing Returns](#org6bc1fd8).
...
### 5.24 [Compounding](#org2a78e26) {#5-dot-24-compounding}

<a id="org2a78e26">Compounding</a> [复利](compound-interest.md)


#### WHAT {#what}

[Compounding](#org2a78e26) is the [Accumulation](#org8ec0c38) of gains over time. Whenever you’re able to
reinvest gains, your investment will build upon itself exponentially—a
positive Feedback Loop.


### 5.25 [Leverage](#org1d61806) {#5-dot-25-leverage}

杠杆原理 <a id="org1d61806">Leverage</a>
[Leverage](#org1d61806) is the practice of using borrowed money to magnify potential gains.
[Leverage](#org1d61806) is a form of financial [Amplification](#orgf3b414d)—it magnifies the potential for both gains and losses.
...
-   [Bond](20210801233920-bond.md) are debt sold to individual lenders.
...
-   A [Initial Public Offering](20210801234009-initial_public_offering.md) involves selling partial ownership of the company to investors on the open market.


### 5.27 [Bootstrapping](#org481dda1) {#5-dot-27-bootstrapping}

<a id="org481dda1">Bootstrapping</a> 自力更生
 [Bootstrapping](#org481dda1) is the art of building and operating a business without Funding.


#### WHY {#why}

[Bootstrapping](#org481dda1) allows you to grow your business while maintaining 100 percent control over the business’s operations.
...
### 5.28 [Return on Investment](#org45303f2) {#5-dot-28-return-on-investment}

<a id="org45303f2">Return on Investment</a> [投资回报率](20210801234144-return_on_investment.md)


#### WHAT {#what}

[Return on Investment](#org45303f2) (ROI) is the value created from an investment of time or resources.


#### WHY {#why}

[Return on Investment](#org45303f2) can help you decide between competing alternatives.
...
### 5.29 [Sunk Cost](#org0bdaf04) {#5-dot-29-sunk-cost}

<a id="org0bdaf04">Sunk Cost</a> [沉没陈本](20210801234216-sunk_cost.md)


#### WHAT {#what}

[Sunk Cost](#org0bdaf04) are investments of time, energy, and money that can’t be recovered
once they’ve been made.


### 5.30 Internal Controls {#5-dot-30-internal-controls}

<a id="org5fbef1f">Internal Control</a>


#### WHAT {#what}

[Internal Control](#org5fbef1f) are a set of specific [Standard Operating Procedure](#orge4e4f54) a
...
[Internal Control](#org5fbef1f) are most useful in four areas:
...
-   Budgeting is the act of estimating future costs and taking steps to ensure
    ...
    important in controlling [Profit](#orgcec0b72) Margins, the [Cash Flow Statement](#org80a94d8) Cycle,
    and [Leverage](#org1d61806).
...
effects of [Willpower](#orgc172ee6) Depletion.
...
deliberation, [Inhibition](#org5c91784), and Decision.
...
### 6.4 [Perceptual Control](#orgf5f0bfd) {#6-dot-4-perceptual-control}

<a id="orgf5f0bfd">Perceptual Control</a> 感知控制


#### WHAT {#what}

In reality, human behavior is much more like a thermostat（温度调节器）This relationship is called [Perceptual Control](#orgf5f0bfd)......and the action we ultimately take depends on the Environment.
...
[Perceptual Control](#orgf5f0bfd) represents a fundamental shift in understanding why people do the things they do. Once you understand that people act to control their perceptions, you’ll be better equipped to influence how they act.


### 6.5 [Reference Level](#orgec6b681) {#6-dot-5-reference-level}

<a id="orgec6b681">Reference Level</a>
 [Reference Level](#orgec6b681)—a range of perceptions（感觉，洞察力）that indicate the system is “under control.”
...
Unless a [Reference Level](#orgec6b681) is violated, people generally will Conserve Energy by not acting.
...
Sources of information that change your [Reference Level](#orgec6b681) are valuable in prompting action.


### 6.7 [Guiding Structure](#org0fefae9) {#6-dot-7-guiding-structure}

<a id="org0fefae9">Guiding Structure</a> 指导框架


#### WHAT {#what}

[Guiding Structure](#org0fefae9) means the structure of your Environment is the largest determinant（决定因素）of your behavior.
...
### 6.8 [Reorganization](#org4ebfc30) {#6-dot-8-reorganization}

<a id="org4ebfc30">Reorganization</a> 重整
...
[Reorganization](#org4ebfc30) is random action that occurs when a [Reference Level](#orgec6b681) is violated but you don’t know what to do to bring the perception back under control.


#### WHY {#why}

[Reorganization](#org4ebfc30) feels like you’re lost, depressed, or crazy—that’s completely normal. Your brain starts spitting out all kinds of off-the-wall things in an effort to find something to fix the situation.


### 6.9 Conflict {#6-dot-9-conflict}

<a id="org80b1fe0">Conflicts</a>
...
[Conflicts](#org80b1fe0) occur when two control systems try to change the same perception.
[Conflicts](#org80b1fe0) occur when people are controlling for different outputs that require the same input.


#### HOW {#how}

[Conflicts](#org80b1fe0) can only be resolved by changing [Reference Level](#orgec6b681)—how success is defined by the parties involved.
...
### 6.13 [Motivation](#org2e943f3) {#6-dot-13-motivation}

<a id="org2e943f3">Motivation</a> [动机](20210801234831-motivation.md)
 [Motivation](#org2e943f3) is an emotion—NOT a logical, rational activity.
[Motivation](#org2e943f3) is an emotional state that links the parts of our brain that feel with the parts that are responsible for action.

[Motivation](#org2e943f3) is the link between the [midbrain and the hindbrain.

break down the experience of [Motivation](#org2e943f3) into: moving \*toward- things that are desirable and moving \*away- from things that aren’t.
...
Very often, Mental Simulation, Patterns, [Conflicts](#org80b1fe0), and Interpretation hidden in the midbrain can get in the way of making progress toward what we want to accomplish. As long as there are “move away from” signals being sent, you’ll have a hard time feeling motivated to move toward what you want.


### 6.14 [Inhibition](#org5c91784) {#6-dot-14-inhibition}

<a id="org5c91784">Inhibition</a> 拘谨，拟制


#### WHAT {#what}

[Inhibition](#org5c91784) is the ability to temporarily override our natural inclinations.

[Willpower](#orgc172ee6)（意志力）is the fuel of [inhibition](#org5c91784).


### 6.15 [Willpower](#orgc172ee6) Depletion {#6-dot-15-willpower-depletion}

<a id="orgc172ee6">Willpower</a> 意志力耗尽


#### WHAT {#what}

[Willpower](#orgc172ee6) can be thought of as instinctual override......[Willpower](#orgc172ee6) are very limited and become Depleted with use.


#### HOW TO AVOID {#how-to-avoid}

    [Willpower](#orgc172ee6) for self-control tasks is dependent on a physiological fuel: blood glucose.
The best way to use your limited reserves of [Willpower](#orgc172ee6) is to use [Guiding Structure](#org0fefae9) to change the structure of your Environment instead of your behavior.


### 6.16 [Loss Aversion](#org264d65f) {#6-dot-16-loss-aversion}

<a id="org264d65f">Loss Aversion</a> [Loss Avuersion](20210801235104-loss_aversion.md)
 [Loss Aversion](#org264d65f) is the idea that people hate to lose things more than they like to gain them.


#### WHY {#why}

[Loss Aversion](#org264d65f) explains why threats typically take precedence over opportunities when it comes to [Motivation](#org2e943f3).

[Loss Aversion](#org264d65f) also explains why uncertainty appears risky.

[Loss Aversion](#org264d65f) is why Risk Reversal is so important if you’re presenting an offer to a potential customer.


#### HOW TO AVOID {#how-to-avoid}

The best way to overcome [Loss Aversion](#org264d65f) is to Reinterpret the risk of loss as "no big deal."


### 6.17 [Threat Lockdown](#org48b99b5) {#6-dot-17-threat-lockdown}

<a id="org48b99b5">Threat Lockdown</a>
...
[Threat Lockdown](#org48b99b5) is a constructive response designed to help you defend yourself, but like many ancient instincts, it often malfunctions（发生故障）in our modern environment.

[Threat Lockdown](#org48b99b5) can easily become a vicious cycle......If you’re experiencing [Threat Lockdown](#org48b99b5), don’t try to repress the threat signal.


#### HOW TO DEAL {#how-to-deal}

The key to dealing with [Threat Lockdown](#org48b99b5) is to convince your mind that the threat no longer exists. You can do that in one of two ways:
...
### 6.19 [Association](#org49ffcdf) {#6-dot-19-association}

<a id="org49ffcdf">Association</a> 联合，关联，联想
...
### 6.20 [Absence Blindness](#org6bc1712) {#6-dot-20-absence-blindness}

   <a id="org6bc1712">Absence Blindness</a>
   [Absence Blindness](#org6bc1712) is a cognitive bias that prevents us from identifying what we can’t observe. Our perceptual faculties evolved to detect objects that are present in the Environment.
The problem is, no one sees all of the bad things that the great manager prevents.


#### WHY {#why}

[Absence Blindness](#org6bc1712) makes prevention（防止）grossly（极度夸张）underappreciated.
...
Because of [Loss Aversion](#org264d65f), people start freaking out and start clamoring for an immediate solution to the collapsing（倒塌；垮掉）market.
...
Experience makes it easier to avoid [Absence Blindness](#org6bc1712).
The only reliable way I’ve found to overcome [Absence Blindness](#org6bc1712) is Checklisting.
...
Our perceptual（感知的；知觉的）faculties（官能，机能）are optimized to notice Contrast, not to compare what we perceive with things that aren’t there, which is the root of [Absence Blindness](#org6bc1712).
...
### 6.22 [Scarcity](#orge6f6f6b) {#6-dot-22-scarcity}

<a id="orge6f6f6b">Scarcity</a> [稀缺性](20210801235515-scarcity.md)
...
[Scarcity](#orge6f6f6b) encourages people to make decisions quickly.
As a result, adding a [Scarcity](#orge6f6f6b) element to your offer is a great way to encourage people to take action.


#### HOW {#how}

add an element of [Scarcity](#orge6f6f6b) to your offer:
...
-   You idealize the desired [End Result to the point that your mind estimates a low probability of achievement, resulting in [Loss Aversion](#org264d65f).
...
Monoidealism is the state of focusing your energy and attention on only one thing, without [conflicts](#org80b1fe0).


#### HOW {#how}

1.  Eliminate potential distractions and interruptions....Turning off my Internet connection...Using similar [Guiding Structure](#org0fefae9) techniques is a good way to prevent your Attention from straying.
2.  Eliminate inner [Conflicts](#org80b1fe0)...Instead of trying to ignore the resistance or push through it (a surefire（万无一失）way to experience [Willpower](#orgc172ee6) Depletion), exploring that resistance using Mental Simulation and Reinterpretation helped me uncover a hidden [Conflicts](#org80b1fe0).
...
Combining this technique with [Parkinson’s Law](#org34009f1) by setting an artificial deadline is extremely effective.
...
-   Positive refers to [Motivation](#org2e943f3)—your Goal should be something you move toward, not away from
-   Immediate refers to time [scale](#orgb765b0f): your Goals should be things that you decide to make progress on now, not “someday” or “eventually.”
...
make your Goals actions that are within your [Locus of Control](#orgf4a85a0), like doing a minimum of thirty minutes of exercise every day and controlling the number of calories you consume.
...
Due to the power of [Accumulation](#org8ec0c38), small Habits can add up to huge results over time.
...
Habits typically require a certain amount of [Willpower](#orgc172ee6) to create. Therefore it’s best to use the techniques we discussed in the section on [Guiding Structure](#org0fefae9) to make it easier to instill the Habits you want to adopt.
...
### 7.17 [Parkinson’s Law](#org34009f1) {#7-dot-17-parkinson-s-law}

帕金森定理 <a id="org34009f1">Parkinson’s Law</a>
...
[Parkinson’s Law](#org34009f1) should not be considered carte blanche to set unreasonable deadlines.


#### HOW {#how}

[Parkinson’s Law](#org34009f1) is best used as a Counterfactual Simulation question.


### 7.18 [Doomsday Scenario](#org7cb5e53) {#7-dot-18-doomsday-scenario}

全球灾难危机 <a id="org7cb5e53">Doomsday Scenario</a>


#### WHAT {#what}

A [Doomsday Scenario](#org7cb5e53) is a Counterfactual Simulation) where you assume everything that can go wrong does go wrong.
...
Once you’ve imagined your [Doomsday Scenario](#org7cb5e53), you can start doing things to improve upon the worst case.
...
### 7.20 [Confirmation Bias](#org92ad999) {#7-dot-20-confirmation-bias}

<a id="org92ad999">Confirmation Bias</a> [确认偏误](20210802000043-confirmation_bias.md)


#### WHAT {#what}

[Confirmation Bias](#org92ad999) is the general tendency for people to pay Attention to information that supports their conclusions and ignore information that doesn’t.


#### HOW {#how}

The best way to counteract（抵制）[Confirmation Bias](#org92ad999) is to intentionally seek out sources of information that challenge your current hypothesis or belief.


### 7.21 [Hindsight Bias](#org7689941) {#7-dot-21-hindsight-bias}

[后视偏差](20210802000158-hindsight_bias.md) <a id="org7689941">Hindsight Bias</a>


#### WHAT {#what}

[Hindsight Bias](#org7689941) is the natural tendency to kick yourself for things you “should have known.”
...
Remember [Parkinson’s Law](#org34009f1): if you don’t set a limit on your available time, your work will expand to fill it all.
...
1.  Work to make “enough” money...Once you have enough money to cover the necessities and a few luxuries, you reach a point of [Diminishing Returns](#org6bc1fd8): every additional dollar you earn doesn’t provide the same amount of utility.
...
The only metric of success that matters is this: are you spending your time doing work you like, with people you enjoy, in a way that keeps you financially Sufficient)? If so, don’t worry about what other people are doing. If not, focus on making changes that are within your [Locus of Control](#orgf4a85a0), so you can start moving in the direction you desire.


### 7.29 [Locus of Control](#orgf4a85a0) {#7-dot-29-locus-of-control}

控制点 <a id="orgf4a85a0">Locus of Control</a>


#### WHAT {#what}

Understanding your [Locus of Control](#orgf4a85a0) is being able to separate what you can control (or strongly influence) from what you can’t. Trying to control things that aren’t actually under your control is a recipe for eternal frustration.
...
When something outside of our [Locus of Control](#orgf4a85a0) affects our plans or Goals, it’s easy to take it personally.
...
Acceptance requires applying the concept of [Sunk Cost](#org0bdaf04) to yourself.
...
习得性无助 <a id="orgb184e8d">Learned Helplessness</a>
...
### 8.2 [Comparative Advantage](#orga1dd09f) {#8-dot-2-comparative-advantage}

比较优势 <a id="orga1dd09f">Comparative Advantage</a>


#### BACKGROUND {#background}

Why work with other people in the first place? The answer is [Comparative Advantage](#orga1dd09f), a concept that originated in the “dismal science” of economics.


#### WHAT {#what}

[Comparative Advantage](#orga1dd09f) means it’s better to capitalize on your strengths than to shore up your weaknesses.
...
### 8.3 Communication [Overhead](#orgb31446e) {#8-dot-3-communication-overhead}
...
Communication [Overhead](#orgb31446e) is the proportion of time you spend communicating with members of your team instead of getting productive work done.


#### HOW TO IDENTIFY {#how-to-identify}

Symptoms of Bureaucratic Breakdown that appear in teams suffering from Communication [Overhead](#orgb31446e):
...
The solution to Communication [Overhead](#orgb31446e) is simple but not easy: make your team as small as possible. You’ll be leaving people out, but that’s the point—including them is causing more work than it’s creating in benefits.
...
Commander’s Intent alleviates（减轻，缓解）Communication [Overhead](#orgb31446e). By communicating the intent behind a certain plan, a leader can make constant communication less critical for the success of the entire team.


### 8.9 Bystander Apathy {#8-dot-9-bystander-apathy}

旁观者效应 <a id="org3ed2efc">Bystander Effect</a>
...
社交信号 <a id="orgaf98806">Signalling Theory</a>
...
takes an action, others perceive it as a Social Signal [Signalling Theory](#orgaf98806),
...
the combination of Authority and [Confirmation Bias](#org92ad999) shelters them from information that contradicts their opinions...it’s difficult for Authority figures to compensate for the Excessive Self-Regard Tendency.
...
Incentives are tricky because they inevitably interact with our [Perceptual Control](#orgf5f0bfd) systems.


### 8.19 [Modal Bias](#orgf334779) {#8-dot-19-modal-bias}

   <<a id="orgf334779">Modal Bias</a>
    [Modal Bias](#orgf334779) is the automatic assumption that our idea or approach is best.
...
The best way to avoid [Modal Bias](#orgf334779) is to use [Inhibition](#org5c91784)（拟制）to temporarily suspend judgment.
...
The [Expectation Effect](#org8d0333b) means that our perception of the quality of someone’s work is a function of our original expectations.
...
By the time you’re aware of an issue, preventing it is beyond your [Locus of Control](#orgf4a85a0). The issue has already occurred—the only question is how you plan to respond to it.
...
1.  Recruit the smallest group of people who can accomplish what must be done quickly and with high quality. [Comparative Advantage](#orga1dd09f) means that some people will be better than others at accomplishing certain tasks, so it pays to invest time and resources in recruiting the best team for the job.
...
Large Stocks have the most Slack, but that flexibility comes at a cost...which increases your costs and decreases your [[Profit Margin](#org45d74c2).
...
Theory of Constraints: any manageable system is always limited in achieving more of its [Goals by at least one Constraint. If you can identify and alleviate the Constraint, you’ll increase the [Throughput](#org7a3f38a) of the system.


#### HOW TO ELIMINATE {#how-to-eliminate}

Goldratt proposes the “Five Focusing Steps,” a method you can use to improve the [Throughput](#org7a3f38a) of any System:
...
Balancing Loops stabilize the system, dampening oscillations and keeping the system in a certain state. [Perceptual Control](#orgf5f0bfd) systems are usually made up of Balancing Loops.
Reinforcing Loops Amplify the system’s output with each system cycle.
[Compounding](#org2a78e26) is an example of a positive Reinforcing Loop


### 9.7 Autocatalysis {#9-dot-7-autocatalysis}

An Autocatalyzing System produces the inputs necessary for the next cycle as a by-[product](#org45e16a1) of the previous cycle, Amplifying the cycle. Autocatalysis is a [Compounding](#org2a78e26), positive, self-reinforcing Feedback Loop—the system will continue to grow until the system changes in a way that produces less output.
...
信用风险 <a id="orgafd3774">Credit Risk</a>
...
Measurement helps us avoid [[Absence Blindness](#org6bc1712) when analyzing a system.
...
Typically, business-related KPIs are directly related to either [The 5 Parts of Every Business or [[Throughput](#org7a3f38a)...identify a business’s KPIs:
...
-   [Sales: How many prospects are becoming paying customers? What is the average customer’s [Lifetime Value](#org2e1af77)?
-   [[Value Delivery](#org77916a8): How quickly can you serve each customer? What is your current returns or complaints rate?
-   [Finance: What is your [Profit Margin](#org45d74c2)? How much [Purchasing Power](#orgec89410) do you have? Are you financially Sufficient?
...
Often, systems companies use this reliability measurement as a Tolerance, and they write a contract called a [Service](#orgea231d4) Level Agreement (SLA) that promises to compensate customers if errors exceed a certain threshold.
...
The best way to maintain Analytical Honesty is to have your measurements evaluated by someone who isn’t personally invested in your system. [Incentive-Caused Bias and [[Confirmation Bias](#org92ad999) are all too easy to succumb to if your social status is on the line.
...
-   [Profit](#orgcec0b72) per Employee: For every person you employ, how much [profit](#orgcec0b72) does your business generate?
...
[Lifetime Value](#org2e1af77) calculations are a form of Segmentation by Past Performance.
...
### 11.1 [Intervention Bias](#org68beb75) {#11-dot-1-intervention-bias}

<a id="org68beb75">Intervention Bias</a>


#### WHAT {#what}

[Intervention Bias](#org68beb75) makes us likely to introduce changes that aren’t necessary in order to feel in control of a situation.


#### HOW {#how}

The best way to correct for [Intervention Bias](#org68beb75) is to examine what scientists call a “null hypothesis”: examining what would happen if you did nothing or assumed the situation was an accident or error.
...
Maximization typically focuses on the system’s [Throughput](#org7a3f38a).
...
### 11.5 [Diminishing Returns](#org6bc1fd8) {#11-dot-5-diminishing-returns}

  <a id="org6bc1fd8">Diminishing Returns</a>
边际产量递减 Diminishing Marginal [Product](#org45e16a1)
All good things are subject to [Diminishing Returns](#org6bc1fd8)—after a certain point, having more of something can actually be detrimental
...
Removing even small amounts of Friction from your Marketing, Sales, and [[Value Delivery](#org77916a8) processes can generate major improvements in [[Profit](#orgcec0b72).
...
Find a way to Automate your system, and you open the doors to [Scale](#orgb765b0f) via [Duplication](#orgbc4213a) and [Multiplication](#org4fbfa45), improving your ability to create and deliver value to more paying customers.
...
### 11.10 [Standard Operating Procedure](#orge4e4f54) {#11-dot-10-standard-operating-procedure}

<a id="orge4e4f54">Standard Operating Procedure</a>


#### WHAT {#what}

A [Standard Operating Procedure](#orge4e4f54) (SOP) is a predefined process used to complete a task or resolve a common issue. Business Systems often include repetitive tasks, and having a standard process in place can help you spend less time reinventing the wheel and more time doing productive work.
...
A Checklist is an Externalized, predefined [Standard Operating Procedure](#orge4e4f54) for completing a specific task.
...
Cessation is the choice to intentionally（有意的） stop doing something that’s counterproductive（适得其反）. Due to [Absence Blindness](#org6bc1712), we’re predisposed to attempt to improve a system by doing something—it “feels wrong” to do nothing.
...
-   Low [overhead](#orgb31446e), [fixed costs](#org75c7c04), and operating expenses
...
### 11.16 [Scenario Planning](#org624d4a7) {#11-dot-16-scenario-planning}

<a id="org624d4a7">Scenario Planning</a>


#### WHAT {#what}

[Scenario Planning](#org624d4a7) is the process of systematically constructing a series of hypothetical situations, then [Mentally Simulating what you would do if they occured. You may not be a seer, but Counterfactual Simulation gives you a powerful capability: imagining things that might occur, then figuring out what you’d do if they did. [Scenario Planning](#org624d4a7) is essentially detailed, thorough, and systematic Counterfactual Simulation applied to major decisions.


#### HOW {#how}

[Scenario Planning](#org624d4a7) always starts with a simple question: “What would I do if. . . ?” The “what if” part is the Counterfactual, and it’s what kicks your planning brain into gear, helping you imagine possible responses.
Most large businesses use [Scenario Planning](#org624d4a7) as the basis of a practice called “hedging”: purchasing various forms of Insurance to reduce the Risk of unfavorable future events.
...
### [VALUE DELIVERY](#org77916a8) {#value-delivery}
...
-   For a full introduction to common [Financial Ratios](#orgcd5a0b9), I recommend _Financial Intelligence for Entrepreneurs_ by Karen Berman and Joe Knight with John Case.
